...
const Messages = () => {
    ...
    return (
        <div id='savedchat' className='messageContainer' ref={messagesRef}>
            ...
            {receiver && <p className={isDark==="false"?'connectedText text-black  text-center ':'text-white text-center '}>You’re now chatting with a random user from your university</p>}
            ...
            {isSearching && <p className={isDark==="false"?'text-black text-center':' text-white text-center'}>Looking for someone you can chat with...</p>}
            {
                !isSearching && !receiver && receiver === "" &&
                <>
